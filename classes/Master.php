...
Class Master extends DBConnection {
	...
	function register(){
			...
			if (
				...
				$sql = "INSERT INTO `clients` (`id`, `firstname`, `lastname`, `gender`, `contact`, `email`, `password`, `default_delivery_address`, `date_created`)
						VALUES (NULL, '$firstname', '$lastname', '$gender', '$contact', '$email', '$password', '', current_timestamp())";
				...
				$resp['status'] = 'failed';
				$resp['msg'] = 'Required fields are not set in $_POST.';
			}
